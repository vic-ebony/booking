...
def batch_process_folder(folder_path, replacements, target_height, target_width, tolerance=0.15, new_date=None, new_version=None):
    """
...
if __name__ == "__main__":
    ...
    if os.path.exists(folder_path):
        batch_process_folder(folder_path, replacements, target_height, target_width, tolerance, new_date, new_version)
    else:
